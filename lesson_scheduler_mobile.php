...
add_filter( 'posts_orderby','lesson_scheduler_orderby_mobile', 10, 2 );
function lesson_scheduler_orderby_mobile( $orderby, $query ) {
...
add_filter( 'posts_where_paged', 'lesson_scheduler_post_where_mobile', 10, 2);
function lesson_scheduler_post_where_mobile( $where, $query ) {
